  ...
  return (
    <div>
      <div className="lauda-page-header">
        ...
        <button className="lauda-btn lauda-btn-primary" onClick={() => alert('Abriremos o formulário de Convite na próxima etapa!')}>
          + Novo Membro
        </button>
      </div>
        ...
        {membros.map(membro => (
          <div key={membro.id} className="lauda-card">
            ...
            <div className="musica-meta text-muted">
              <span><strong>Acesso:</strong> Nível {membro.nivel_acesso}</span>
            </div>
          </div>
        ))}
      </div>
